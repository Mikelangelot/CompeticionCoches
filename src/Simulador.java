public class Simulador {
    public static void main(String[] args) {
        ...
        Piloto piloto1 = new Piloto("Fernando",44,coche1,0.9);
        Piloto piloto2 = new Piloto("Carlos",44,coche1,0.6);
        Piloto piloto3 = new Piloto("Max",44,coche1,0.7);
        Piloto piloto4 = new Piloto("Colapinto",44,coche1,0.6);
        Piloto piloto5 = new Piloto("Hamilton",44,coche1,0.8);
        Piloto piloto6 = new Piloto("Vettel",44,coche1,0.7);


        Competicion competicion1 = new Competicion("GP de España",1);
        Competicion competicion2 = new Competicion("Gp de Bahrein", 2);

        Carrera carrera1 = new Carrera(1,46,1,6);
